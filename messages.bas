...
'  { Combo Box notifications  }
   Public Enum Combe_Box_Notification
     CBN_CLOSEUP = 8
     CBN_DBLCLK = 2
     CBN_DROPDOWN = 7
     CBN_EDITCHANGE = 5
...
'  { Header control  }
  Public Enum Files
     ...
     HDM_SETITEMA = 4612
'{$ifdef UNICODE}
     HDM_GETITEM_Unicode = HDM_GETITEMW
     HDM_INSERTITEM_Unicode = HDM_INSERTITEMW
     HDM_SETITEM_Unicode = HDM_SETITEMW
'{$else}
...
'  { Header control notifications  }
     ...
     HDN_TRACKA = -(308)
'{$ifdef UNICODE}
     HDN_BEGINTRACK_Unicode = HDN_BEGINTRACKW
     HDN_DIVIDERDBLCLICK_Unicode = HDN_DIVIDERDBLCLICKW
     HDN_ENDTRACK_Unicode = HDN_ENDTRACKW
     HDN_ITEMCHANGED_Unicode = HDN_ITEMCHANGEDW
     HDN_ITEMCHANGING_Unicode = HDN_ITEMCHANGINGW
     HDN_ITEMCLICK_Unicode = HDN_ITEMCLICKW
     HDN_ITEMDBLCLICK_Unicode = HDN_ITEMDBLCLICKW
     HDN_TRACK_Unicode = HDN_TRACKW
'{$else}
...
'  { List box notifications  }
  Public Enum ListBox_Notifications
     LBN_DBLCLK = 2
     LBN_ERRSPACE = -(2)
     LBN_KILLFOCUS = 5
     LBN_SELCANCEL = 3
...
'{$ifdef UNICODE}
     LVM_EDITLABEL_Unicode = LVM_EDITLABELW
     LVM_FINDITEM_Unicode = LVM_FINDITEMW
     LVM_GETCOLUMN_Unicode = LVM_GETCOLUMNW
     LVM_GETISEARCHSTRING_Unicode = LVM_GETISEARCHSTRINGW
     LVM_GETITEM_Unicode = LVM_GETITEMW
     LVM_GETITEMTEXT_Unicode = LVM_GETITEMTEXTW
     LVM_GETSTRINGWIDTH_Unicode = LVM_GETSTRINGWIDTHW
     LVM_INSERTCOLUMN_Unicode = LVM_INSERTCOLUMNW
     LVM_INSERTITEM_Unicode = LVM_INSERTITEMW
     LVM_SETCOLUMN_Unicode = LVM_SETCOLUMNW
     LVM_SETITEM_Unicode = LVM_SETITEMW
     LVM_SETITEMTEXT_Unicode = LVM_SETITEMTEXTW
'{$else}
...
'  { List view control notifications  }
  Public Enum Listview_Notifications
     LVN_BEGINDRAG = -(109)
     LVN_BEGINRDRAG = -(111)
     LVN_COLUMNCLICK = -(108)
...
'{$ifdef UNICODE}
     LVN_BEGINLABELEDIT_Unicode = LVN_BEGINLABELEDITW
     LVN_ENDLABELEDIT_Unicode = LVN_ENDLABELEDITW
     LVN_GETDISPINFO_Unicode = LVN_GETDISPINFOW
     LVN_SETDISPINFO_Unicode = LVN_SETDISPINFOW
'{$else}
...
'  { Control notification  }
  Public Enum Control_notifications
     NM_CLICK = -(2)
     NM_DBLCLK = -(3)
     NM_KILLFOCUS = -(8)
     NM_OUTOFMEMORY = -(1)
...
'  { Property sheets  }
  Public Enum Property_Sheets
     ...
     PSM_SETTITLEA = 1135
'{$ifdef UNICODE}
     PSM_SETFINISHTEXT_Unicode = PSM_SETFINISHTEXTW
     PSM_SETTITLE_Unicode = PSM_SETTITLEW
'{$else}
...
'  { Property sheet notifications  }
  Public Enum Property_Sheets_Notifications
     PSN_APPLY = -(202)
     PSN_HELP = -(205)
     PSN_KILLACTIVE = -(201)
     PSN_QUERYCANCEL = -(209)
...
'  { Status window  }
  Public Enum StatusWindow
     ...
     SB_SETTEXTA = 1025
'{$ifdef UNICODE}
     SB_GETTEXT_Unicode = SB_GETTEXTW
     SB_GETTEXTLENGTH_Unicode = SB_GETTEXTLENGTHW
     SB_SETTEXT_Unicode = SB_SETTEXTW
'{$else}
...
'  { Static control notifications  }
  Public Enum Static_Control_Notifications
     STN_CLICKED = 0
     STN_DBLCLK = 1
     STN_DISABLE = 3
     STN_ENABLE = 2
...
'{$ifdef UNICODE}
     TB_ADDSTRING_Unicode = TB_ADDSTRINGW
     TB_GETBUTTONTEXT_Unicode = TB_GETBUTTONTEXTW
     TB_SAVERESTORE_Unicode = TB_SAVERESTOREW
'{$else}
...
'  { Tool bar control notifications  }
  Public Enum Toolbar_Notifications
     TBN_BEGINADJUST = -(703)
     TBN_BEGINDRAG = -(701)
     TBN_CUSTHELP = -(709)
     TBN_ENDADJUST = -(704)
...
'{$ifdef UNICODE}
     TBN_GETBUTTONINFO_Unicode = TBN_GETBUTTONINFOW
'{$else}
...
'  { Tab control  }
  Public Enum Tab_Control
     ...
     TCM_SETITEMA = 4870
'{$ifdef UNICODE}
     TCM_GETITEM_Unicode = TCM_GETITEMW
     TCM_INSERTITEM_Unicode = TCM_INSERTITEMW
     TCM_SETITEM_Unicode = TCM_SETITEMW
'{$else}
...
'  { Tab control notifications  }
  Public Enum Tab_Control_Notifications
     TCN_KEYDOWN = -(550)
     TCN_SELCHANGE = -(551)
     TCN_SELCHANGING = -(552)
  End Enum
...
'{$ifdef UNICODE}
  ...
  Public Enum ToolTip
     TTM_ADDTOOL_Unicode = TTM_ADDTOOLW
     TTM_DELTOOL_Unicode = TTM_DELTOOLW
     TTM_ENUMTOOLS_Unicode = TTM_ENUMTOOLSW
     TTM_GETCURRENTTOOL_Unicode = TTM_GETCURRENTTOOLW
     TTM_GETTEXT_Unicode = TTM_GETTEXTW
     TTM_GETTOOLINFO_Unicode = TTM_GETTOOLINFOW
     TTM_HITTEST_Unicode = TTM_HITTESTW
     TTM_NEWTOOLRECT_Unicode = TTM_NEWTOOLRECTW
     TTM_SETTOOLINFO_Unicode = TTM_SETTOOLINFOW
     TTM_UPDATETIPTEXT_Unicode = TTM_UPDATETIPTEXTW
'{$else}
...
'  { Tool tip control notification  }
  Private Enum ToolTip_N_P
     TTN_NEEDTEXTW = -(530)
     TTN_NEEDTEXTA = -(520)
  End Enum
  
'{$ifdef UNICODE}
  Public Enum ToolTip_Notification
     TTN_NEEDTEXT_Unicode = TTN_NEEDTEXTW
'{$else}
...
'  { Tree view control  }
  Public Enum TreeView
     ...
     TVM_SETITEMA = 4365
'{$ifdef UNICODE}
     TVM_EDITLABEL_Unicode = TVM_EDITLABELW
     TVM_GETISEARCHSTRING_Unicode = TVM_GETISEARCHSTRINGW
     TVM_GETITEM_Unicode = TVM_GETITEMW
     TVM_INSERTITEM_Unicode = TVM_INSERTITEMW
     TVM_SETITEM_Unicode = TVM_SETITEMW
'{$else}
...
'  { Tree view control notification  }
  Public Enum Treeview_Notification
     TVN_KEYDOWN = -(412)
     TVN_BEGINDRAGW = -(456)
...
'{$ifdef UNICODE}
     TVN_BEGINDRAG_Unicode = TVN_BEGINDRAGW
     TVN_BEGINLABELEDIT_Unicode = TVN_BEGINLABELEDITW
     TVN_BEGINRDRAG_Unicode = TVN_BEGINRDRAGW
     TVN_DELETEITEM_Unicode = TVN_DELETEITEMW
     TVN_ENDLABELEDIT_Unicode = TVN_ENDLABELEDITW
     TVN_GETDISPINFO_Unicode = TVN_GETDISPINFOW
     TVN_ITEMEXPANDED_Unicode = TVN_ITEMEXPANDEDW
     TVN_ITEMEXPANDING_Unicode = TVN_ITEMEXPANDINGW
     TVN_SELCHANGED_Unicode = TVN_SELCHANGEDW
     TVN_SELCHANGING_Unicode = TVN_SELCHANGINGW
     TVN_SETDISPINFO_Unicode = TVN_SETDISPINFOW
'{$else}
...
'  { Up/down control  }
  ...
  Public Enum UpDown_Notification
...
Public Sub SetNumber(NumberText As TextBox, Optional MakeNumeric As Boolean = True)
    Dim curstyle As Long
    Dim newstyle As Long
    'This Function uses 2 API functions to s
    '     et the style of
    'a textbox so it will only accept number
    '     s CShell
